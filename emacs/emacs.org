...
* Markdown
Mostly works well out of the box.

** markdown-indent-mode
https://github.com/whhone/markdown-indent-mode provides layout similar
to org-mode, making the semantic structure way easier to visually
parse.
